...
namespace CornerStoneApril30.Controllers
{
    public class SchoolsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Address,Phone")] School school)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Address,Phone")] School school)
        {
            if (id != school.ID)
            {
                return NotFound();
